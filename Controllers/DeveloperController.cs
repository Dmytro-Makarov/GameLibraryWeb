...
namespace GameLibWeb.Controllers
{
    public class DeveloperController : Controller
    {
        ...
        {
            var dbgamelibContext = _context.Developers.Include(d => d.LibraryMedia);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(uint id, [Bind("Id,Name,Info,LibraryMediaId")] Developer developer)
        {
            if (id != developer.Id)
            {
                return NotFound();
